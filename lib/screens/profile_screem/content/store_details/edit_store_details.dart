...
class EditStoreDetail extends StatefulWidget {
  ...
  @override
  State<EditStoreDetail> createState() => _EditStoreDetailState();
}

class _EditStoreDetailState extends State<EditStoreDetail> {
  ...
  void _getDetails() async {
    _storeData = widget.data;
    _setController();
  }

  void _setPhone() {
    if (padQuotes(ConnectHiveSessionData.getUserPhone()).isNotEmpty) {
      _contactNumber.text = ConnectHiveSessionData.getUserPhone();
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child: buildText(
                      'Photo with Dry Goods / Live Product',
                      fontSize: 18,
                      fontWeight: FontWeight.w500,
                      alignment: TextAlign.left,
                    ),
                  ...
                  Consumer<PersonalDetailsProvider>(
                    ...
                    return TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        hintText:
                            provider.pickedLicenceFileName ?? 'Select Files',
                      ),
                      validator: (v) {
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          _personalDetailsProvider.pickStoreLicenceFile();
                        },
                        child: buildText(
                          'Pick File',
                          fontSize: 16,

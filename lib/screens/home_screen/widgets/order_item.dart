...
class _OrderItemState extends State<OrderItem> {
  ...
  Widget build(BuildContext context) {
    debugPrint('produ '+_productDetails.toString());
    return GestureDetector(
      onTap: () {
        nav(context, OrderDetail(data: widget.data));
      },
      child: Card(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: buildText(
                                  padQuotes(_productDetails['product_name']),
                          ...
                          Row(
                            ...
                            children: [
                              buildText(
                                '₹ ${padQuotes(_orderDetails['order_total_price'])}/-',
  ...
  String _subtextByType() {
    ...
    switch (_productDetails['product_type']) {
      case 'Live product':
        text = padQuotes(_productDetails['age']);
        break;
      case 'Food':
        text = padQuotes(_productDetails['brand']);
        break;
      case 'AQUARIUM':
        text = padQuotes(_productDetails['brand']);
        break;

...
class EquipmentDetail extends StatefulWidget {
  final Map data;
  EquipmentDetail({Key? key, required this.data}) : super(key: key);

  @override
  State<EquipmentDetail> createState() => _LiveProductState();
}

class _LiveProductState extends State<EquipmentDetail> {

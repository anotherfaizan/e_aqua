...
class AquariumDetail extends StatefulWidget {
  final Map data;
  AquariumDetail({Key? key, required this.data}) : super(key: key);

  @override
  State<AquariumDetail> createState() => _LiveProductState();
}

class _LiveProductState extends State<AquariumDetail> {

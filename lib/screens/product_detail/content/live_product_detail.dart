...
class LiveProductDetail extends StatefulWidget {
  final Map data;
  LiveProductDetail({Key? key, required this.data}) : super(key: key);

  @override
  State<LiveProductDetail> createState() => _LiveProductState();
}

class _LiveProductState extends State<LiveProductDetail> {
        ...
        children: [
          buildListItem(
            title: widget.data['age'] != null
                ? padQuotes(widget.data['age']) + ' Year'
                : 'NA',
            image: 'pet_age_big.png',
          ),
          buildListItem(
            title: widget.data['gender'] ?? 'NA',
            image: null,
          ),
          buildListItem(

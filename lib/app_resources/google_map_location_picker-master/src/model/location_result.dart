...
class LocationResult {
  ...
  LocationResult({this.latLng, this.address, this.placeId, this.placemark});

  @override
  String toString() {
    return 'LocationResult{address: $address, latLng: $latLng, placeId: $placeId, placemark:$placemark}';
  }
}
